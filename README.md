[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=10746540&assignment_repo_type=AssignmentRepo)
...
Badger News does a few things better than Badger Bakery to make it more mobile-friendly. First, it has navigation that feels more mobile-friendly. With bottom tabs, the ability to switch between the news and preference page is much easier. Moreover, I used cards and modals within Badger News which are much friendlier on mobile compared to Badger Bakery's switching between each baked good in a static way.
...
One perceptible affordance is the preference page. In the context of preferences and the switches, you can perceive that clicking the switch, to turn off that preference, would remove articles with that tag, and this would be the correct assumption. One hidden affordance we could have is that swiping from one side will switch to the other tab. i.e. swiping right to left opens preference page and left to right would open the news page.
...
One metaphoric design we could do is, instead of cards of individual articles, we could have a 'newspaper' that would look and feel similar to a newspaper. To get to a different article, we would need to swipe to get to a new article. One benefit would be a more realistic feel, but one downside would be needing to learn how to navigate through the 'newspaper'.
...
One business goal this application may have is to show a variety of articles to users. The posture level of this application could be a 'news/article app'. One task a user may try to do is open an article and read it. This is supported through tapping the article cards, which opens a modal to read the article. Furthermore, another task a user may want to do is filter out articles with certain tags, and this can be done by toggling the switches in the preferences pages.
